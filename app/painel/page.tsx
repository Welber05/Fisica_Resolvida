    ...
    <main className="dashboard-page">
      ...
      <section className="dashboard-columns">
        <article className="dashboard-panel"><header><div><p className="eyebrow">ACESSOS RÁPIDOS</p><h2>Operação da plataforma</h2></div></header><div className="quick-grid">
          ...
          <a href="/painel/questoes"><span>{canManageUsers ? '03' : '01'}</span><strong>Questões cadastradas</strong><p>Editar classificações, BNCC, dificuldade, status e fonte das questões.</p><b>Curar questões →</b></a>
          <a href="/painel/conteudo"><span>{canManageUsers ? '04' : '02'}</span><strong>Conteúdo acadêmico</strong><p>Gerenciar lotes, provas, roteiros e videoaulas.</p><b>Gerenciar →</b></a>
          <a href="/conta"><span>{canManageUsers ? '05' : '03'}</span><strong>Minha conta</strong><p>Perfil, endereço, imagem e faturamento pessoal.</p><b>Editar →</b></a>
        </div></article>
