...
function PersonFields({ user, allowedRoles, includeRole = false }: { user?: SafeUser; allowedRoles?: AppRole[]; includeRole?: boolean }) {
  return <div className="admin-form-grid">
    ...
    <label>CEP <small>obrigatório</small><input name="addressPostalCode" required defaultValue={user?.address.postalCode} /></label><label className="wide">Logradouro <small>obrigatório</small><input name="addressStreet" required defaultValue={user?.address.street} /></label><label>Número <small>obrigatório</small><input name="addressNumber" required defaultValue={user?.address.number} /></label><label>Cidade <small>obrigatório</small><input name="addressCity" required defaultValue={user?.address.city} /></label><label>Estado <small>obrigatório</small><input name="addressState" required defaultValue={user?.address.state} /></label><label>País <small>obrigatório</small><input name="addressCountry" required defaultValue={user?.address.country || 'Brasil'} /></label>
