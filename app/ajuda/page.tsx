  ...
  return (
    <main className="guide-page">
      <header className="guide-hero">
        ...
        <Link href="/">← Voltar ao acervo</Link>
      </header>
      <article className="guide-content">
        ...
        <footer><Link className="primary" href={canManage ? '/painel' : '/'}>{canManage ? 'Abrir painel de gestão' : 'Abrir banco de questões'} →</Link><Link href="/conta">Editar minha conta</Link></footer>
      </article>
    </main>
  );
}
